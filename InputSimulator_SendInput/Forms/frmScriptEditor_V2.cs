...
{
    public partial class frmScriptEditor_V2 : Form
    {
        /// <summary>
        /// 当前已选择的操作类型
        /// </summary>
        ...
        /// 脚本内容
        /// </summary>
        private ScriptContent SCT = null;
        private string ScriptPath = "";

        public frmScriptEditor_V2() { InitializeComponent(); ClearScriptInfo(); InitPage(); }
        public frmScriptEditor_V2(ScriptContent _sct, string _scriptPath) { InitializeComponent(); ClearScriptInfo(); SCT = _sct; ScriptPath = _scriptPath; InitPage(); }
        ...
        private void tb_ScriptName_Leave(object sender, EventArgs e)
        {
            ...
            string str = string.IsNullOrWhiteSpace(ScriptPath) ? Application.StartupPath + "\\Scripts\\" : ScriptPath.Substring(0, ScriptPath.LastIndexOf("\\"));

            //if (string.IsNullOrWhiteSpace(tb_SavePath.Text))
            tb_SavePath.Text = string.Format("{0}\\{1}.txt", str, tb_ScriptName.Text);
        }
        ...
        public void ClearScriptInfo()
        {
            ...
            tb_SavePath.Text = string.Format("{0}\\Scripts\\{1}.txt", Application.StartupPath, tb_ScriptName.Text);
            cb_HotKey.Text = "";
            tb_ShowOrder.Text = "1";
        ...
        public void LoadScriptInfo()
        {
            ...
            tb_ScriptName.Text = SCT.Name;
            cb_HotKey.Text = SCT.HotKey;
            tb_ShowOrder.Text = SCT.Order.ToString();
            tb_SavePath.Text = ScriptPath;
            swb_ActiveState.SwitchState = SCT.Enable;

            string ScriptContent = "";// SCT.Actions.ToString();

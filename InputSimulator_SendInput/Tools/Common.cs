...
namespace InputSimulator_SendInput.Tools
{
    public static class Common
    {
        ...
        /// </summary>
        /// <param name="ls"></param>
        public static void SortScriptActionList(List<ScriptAction> ls)
        {
            try
            {
                ls.Sort((x, y) =>
                {
                    decimal orderX = Convert.ToDecimal(x.SerialNo);
                    decimal orderY = Convert.ToDecimal(y.SerialNo);
                    return orderX.CompareTo(orderY);
                });
            }
            catch { }
